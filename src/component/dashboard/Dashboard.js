...
const [status, setStatus] = useState('');
 ...
 useEffect(() => {
             let statusl = localStorage.getItem('status');
             setStatus(statusl)
        });
     ...
     window.location.href = "/login";
        ...
        <section className="ftco-section">
         ...
         <div className="row justify-content-center">
               ...
               <div className="col-md-6">
               { status == "true" ?
                    <button className="btn waves-effect waves-light" onClick={logOut} type="submit" name="action"> Log out </button>
                    :
                    <button className="btn waves-effect waves-light" onClick={logIn} type="submit" name="action"> Log in </button>
                    }
               </div>
         </div>
            <br/><br/>
